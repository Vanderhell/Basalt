...
internal static class SqlTransactions
{
    ...
    internal static JobDbResult Commit(IntPtr handle){State s=Get(handle);try{s.Transaction.Commit();s.Completed=true;return JobDbResult.Ok;}catch(Microsoft.Data.SqlClient.SqlException){return JobDbResult.UnknownCommit;}catch{return JobDbResult.Io;}}
