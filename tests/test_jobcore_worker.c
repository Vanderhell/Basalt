...
static void clean_db(void){remove("jobcore-worker/manifest.0");remove("jobcore-worker/manifest.1");remove("jobcore-worker/wal.0");remove("jobcore-worker/coordination.lock");remove("jobcore-worker/record.3.1");remove("jobcore-worker/record.100.1");}
